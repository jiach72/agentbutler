...
/**
 * 实例状态 → 规范语义 tone。
 * v2 起不再用「只有色点」的形态表达状态（规范 §1 P3 / §6：颜色 + 图标 + 文字至少取二），
 * 所以这里只提供 tone，标签文字用 instanceStateLabel。
 */
const stateTone = {
  up: "ok",
  down: "error",
            ...
            <Card size="small" style={{ height: "100%" }}>
              <Flex vertical gap={8}>
                <Flex wrap="wrap" align="center" gap={8}>
                  <StatusBadge
                    tone={stateTone[stateDotClass(instance.state) as keyof typeof stateTone] ?? "unknown"}
